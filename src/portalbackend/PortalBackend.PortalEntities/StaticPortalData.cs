...
public static class StaticPortalData
{
    ...
    public static ICollection<CompanyRole> CompanyRoles => new []
    {
        new CompanyRole(CompanyRoleId.ACTIVE_PARTICIPANT, new Guid("8cb12ea2-aed4-4d75-b041-ba297df3d2f2"), true),
        new CompanyRole(CompanyRoleId.APP_PROVIDER, new Guid("ec428950-8b64-4646-b336-28af869b5d73"), true),
        new CompanyRole(CompanyRoleId.SERVICE_PROVIDER, new Guid("a5b8b1de-7759-4620-9c87-6b6d74fb4fbc"),  true),
        new CompanyRole(CompanyRoleId.OPERATOR, new Guid("1a24eca5-901f-4191-84a7-4ef09a894575"), false),
    };
