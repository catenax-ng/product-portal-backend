...
namespace Org.CatenaX.Ng.Portal.Backend.PortalBackend.Migrations.Migrations
{
    ...
    [Migration("20221021222653_CPLP-1524-UserRoleCollections")]
    partial class CPLP1524UserRoleCollections
    {
            ...
            modelBuilder.Entity("Org.CatenaX.Ng.Portal.Backend.PortalBackend.PortalEntities.Entities.CompanyRole", b =>
                {
                    ...
                    b.HasIndex("UserRoleCollectionId")
                        .IsUnique()
                        .HasDatabaseName("ix_company_roles_user_role_collection_id");
            ...
            modelBuilder.Entity("Org.CatenaX.Ng.Portal.Backend.PortalBackend.PortalEntities.Entities.CompanyRole", b =>
                {
                    b.HasOne("Org.CatenaX.Ng.Portal.Backend.PortalBackend.PortalEntities.Entities.UserRoleCollection", "UserRoleCollection")
                        .WithOne("CompanyRole")
                        .HasForeignKey("Org.CatenaX.Ng.Portal.Backend.PortalBackend.PortalEntities.Entities.CompanyRole", "UserRoleCollectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_company_roles_user_role_collections_user_role_collection_id");
