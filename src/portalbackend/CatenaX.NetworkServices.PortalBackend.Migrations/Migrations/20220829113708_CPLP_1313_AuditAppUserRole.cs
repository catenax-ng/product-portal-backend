...
{
    public partial class CPLP_1313_AuditAppUserRole : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "audit_user_roles_cplp_1313_db_audit_apps",
                schema: "portal",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_audit_user_roles_cplp_1313_db_audit_apps", x => x.id);
                });
