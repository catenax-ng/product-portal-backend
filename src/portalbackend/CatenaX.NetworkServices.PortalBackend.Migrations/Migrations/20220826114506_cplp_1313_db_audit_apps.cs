...
{
    public partial class cplp_1313_db_audit_apps : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "audit_app_user_roles_cplp_1313_db_audit_apps",
                schema: "portal",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_audit_app_user_roles_cplp_1313_db_audit_apps", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "audit_apps_cplp_1313_db_audit_apps",
                schema: "portal",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_audit_apps_cplp_1313_db_audit_apps", x => x.id);
                });
           
            migrationBuilder.AddAuditTrigger<AuditApp>("cplp_1313_db_audit_apps");
            migrationBuilder.AddAuditTrigger<AuditUserRole>("cplp_1313_db_audit_apps");
        }
