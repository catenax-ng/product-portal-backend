...
public class ServiceBusinessLogicTests
{
    ...
    {
        A.CallTo(() => _offerRepository.GetServiceUpdateData(_notExistingServiceId, A<IEnumerable<ServiceTypeId>>._, A<Guid>._, _iamUser.UserEntityId, A<string>._))
            .ReturnsLazily(() => (ServiceUpdateData?)null);
        A.CallTo(() => _offerRepository.GetServiceUpdateData(_activeServiceId, A<IEnumerable<ServiceTypeId>>._, A<Guid>._, _iamUser.UserEntityId, A<string>._))
        ...
        A.CallTo(() => _offerRepository.GetServiceUpdateData(_differentCompanyServiceId, A<IEnumerable<ServiceTypeId>>._, A<Guid>._, _iamUser.UserEntityId, A<string>._))
        ...
        A.CallTo(() => _offerRepository.GetServiceUpdateData(_existingServiceId, A<IEnumerable<ServiceTypeId>>._, A<Guid>._, _iamUser.UserEntityId, A<string>._))
