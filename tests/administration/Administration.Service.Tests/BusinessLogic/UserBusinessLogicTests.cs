...
public class UserBusinessLogicTests
{
    ...
    public async Task ModifyUserRoleAsync_WithTwoNewRoles_AddsTwoRolesToTheDatabase()
    {
        ...
        await sut.ModifyOfferUserRolesAsync(_validOfferId, userRoleInfo, _createdCentralUserId).ConfigureAwait(false);
    ...
    public async Task ModifyUserRoleAsync_WithOneRoleToDelete_DeletesTheRole()
    {
        ...
        await sut.ModifyOfferUserRolesAsync(_validOfferId, userRoleInfo, _adminIamUser).ConfigureAwait(false);
    ...
    public async Task ModifyUserRoleAsync_WithNotExistingRole_ThrowsException()
    {
        ...
        async Task Action() => await sut.ModifyOfferUserRolesAsync(_validOfferId, userRoleInfo, _adminIamUser).ConfigureAwait(false);
    ...
    public async Task ModifyUserRoleAsync_WithInvalidOfferId_ThrowsException()
    {
        ...
        async Task Action() => await sut.ModifyOfferUserRolesAsync(invalidAppId, userRoleInfo, _adminIamUser).ConfigureAwait(false);
    ...
    private void SetupFakesForUserRoleModification()
    {
        ...
        A.CallTo(() => _userRolesRepository.GetAssignedAndMatchingOfferRoles(A<Guid>._, A<IEnumerable<string>>._, A<Guid>._))
